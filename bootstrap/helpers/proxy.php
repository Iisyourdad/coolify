            ...
            'services' => [
                'traefik' => [
                    ...
                    'command' => [
                        ...
                        '--api.dashboard=true',
                        '--entrypoints.'.traefikHttpEntrypoint().'.address=:80',
                        '--entrypoints.'.traefikHttpsEntrypoint().'.address=:443',
                        ...
                        '--certificatesresolvers.'.traefikPublicCertResolver().'.acme.httpchallenge=true',
                        '--certificatesresolvers.'.traefikPublicCertResolver().'.acme.httpchallenge.entrypoint='.traefikHttpEntrypoint(),
                        '--certificatesresolvers.'.traefikPublicCertResolver().'.acme.storage=/traefik/acme.json',
                    ],
                    'labels' => $labels,
                ],
            ],
