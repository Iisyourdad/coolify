            ...
            @if ($resourceType === 'application')
                ...
                @if ($currentRoute === 'project.service.index.advanced')
                    <section class="application-settings-section">
                        ...
                        <x-forms.listbox id="excludeFromMasterDomainRouting" label="Master domain routing"
                            onChange="instantSaveApplicationSettings"
                            helper="When excluded, Coolify removes this compose resource from the generated master router. Including it regenerates the route."
                            :options="[
                                ['value' => false, 'label' => 'Include in master domain routing'],
                                ['value' => true, 'label' => 'Exclude from master domain routing'],
                                ...
                                @if (!$serviceApplication->serviceType()?->contains(str($serviceApplication->image)->before(':')))
                                    <div class="rounded-lg border border-neutral-200 p-4 dark:border-white/[0.08]">
                                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                            <div class="min-w-0 text-sm text-neutral-500 dark:text-fg-dim">
                                                <p>Manage domains, DNS checks, and redirects on the parent service.</p>
